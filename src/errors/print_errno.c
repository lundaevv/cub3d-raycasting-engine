...
/*   Updated: 2026/03/03 13:30:11 by vlundaev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static const char	*msg_for_err(t_err err)
{
	static const char	*msgs[] = {NULL, ERRMSG_ARGS, ERRMSG_EXT, ERRMSG_OPEN,
		...
		ERRMSG_CONF_PATH, ERRMSG_CONF_COLOR, ERRMSG_MAP_EMPTY,
		ERRMSG_MAP_CHAR, ERRMSG_MAP_PLAYER, ERRMSG_MAP_OPEN, ERRMSG_PARSE};
